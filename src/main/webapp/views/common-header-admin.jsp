<body>
	...
	<div class="row bg-light" style="height: 70px; ">
		...
		<div class="col-9 d-flex justify-content-end align-items-center">
				 ...
				 <a class="btn btn-sm btn-white mr-3" href="/admin/contactList" role="button"><i class="fas fa-comment-medical"></i> User Messages</a>
					    
		         <a class="btn btn-sm btn-white mr-3" href="/admin/admlogout" role="button"><i class="fas fa-sign-out-alt"></i> Logout</a>
